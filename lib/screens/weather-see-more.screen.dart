                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                              "High ${this._weather?.forecasts[0]?.high}° / Low ${this._weather?.forecasts[0]?.low}°"),
                        ),
                        SizedBox(height: 20),
                        Row(
  ...
  Widget listDataItems(int date, int high, int low, String text) {
    return Column(
      children: [
        ...
        SizedBox(height: 10),
        Text(
            "${date == 0 ? 'Today' : DateFormat('EEEE').format(DateTime.fromMillisecondsSinceEpoch(date * 1000))}",
            style: TextStyle(
                color: AppColors.SecondaryTextColor,
                fontWeight: FontWeight.bold,
                fontSize: 20))
